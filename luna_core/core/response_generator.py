...
class LunaContextAnalyzer:
    ...
    # V5.1: Heartbeat pulse helper methods
    def _now(self) -> float:
    ...
    def _compute_pulse_metrics(self, now_ts: float) -> tuple:
        ...
        Returns:
            (pulse_bpm, pulse_hvv, ones, ticks) where:
            - pulse_bpm: ones per second in window
            - pulse_hvv: std dev of inter-1 spacings (tick units)
            - ones: count of 1s
            - ticks: total ticks
        """
